const locales = {
  en: {
    ...
    SHARE_LOCATION_PROMPT: `📱 **On Mobile:** Use the "Share My Location" button.\n💻 **On Desktop:** Simply type the name of your city.`,
    LOCATION_SAVED:
  ...
  am: {
    ...
    SHARE_LOCATION_PROMPT:
      '📱 **በሞባይል ላይ:** "አካባቢዬን አጋራ" የሚለውን ቁልፍ ይጠቀሙ።\n💻 **በኮምፒውተር ላይ:** በቀላሉ የከተማዎን ስም ይጻፉ።',
    LOCATION_SAVED:
  ...
  om: {
    ...
    SHARE_LOCATION_PROMPT:
      '📱 **Moobayilarratti:** Qabduu "Iddoo Koo Qoodi" jedhu fayyadami.\n💻 **Deeskitooppiirratti:** Maqaa magaalaa keetii barreessi.',
    LOCATION_SAVED:
  ...
  ti: {
    ...
    SHARE_LOCATION_PROMPT:
      '📱 **ኣብ ሞባይል:** ነታ "ቦታይ ኣካፍል" እትብል መላግቦ ተጠቐም።\n💻 **ኣብ ኮምፒተር:** ስም ከተማኻ ጽሓፍ።',
    LOCATION_SAVED:
  ...
  tr: {
    ...
    SHARE_LOCATION_PROMPT:
      '📱 **Mobilde:** "Konumumu Paylaş" düğmesini kullanın.\n💻 **Masaüstünde:** Sadece şehrinizin adını yazın.',
    LOCATION_SAVED:
...
MENU_HELP: "❓ مدد",
FETCHING_PRAYER_TIMES: "آج کے نماز کے اوقات آپ کے لیے حاصل کیے جا رہے ہیں...",
PRAYER_TIMES_FETCH_ERROR: "معذرت، میں اس وقت اس مقام کے لیے نماز کے اوقات حاصل نہیں کر سکا۔",
CITY_NOT_FOUND: "شہر نہیں ملا۔ براہ کرم ہجے چیک کریں یا قریبی بڑے شہر کو آزمائیں۔",
...
DATA_DELETED: "آپ کا تمام ڈیٹا حذف کر دیا گیا ہے۔ دوبارہ شروع کرنے کے لیے نیا مقام بھیجیں۔",
MENU_FEEDBACK: "📝 رائے دیں",
SETTINGS_BTN_BACK: "« مرکزی مینو پر واپس",
MAIN_MENU_PROMPT: "آپ آگے کیا کرنا چاہیں گے؟",
FEEDBACK_PROMPT: "ہمیں آپ کی رائے سن کر خوشی ہوگی! ہمارے فیڈ بیک بوٹ کے ساتھ چیٹ کھولنے کے لیے نیچے دیے گئے بٹن پر کلک کریں۔",
...
PRAYER_TIMES_FETCH_ERROR: "क्षमा करें, मैं अभी उस स्थान के लिए नमाज़ का समय नहीं ला सका।",
CITY_NOT_FOUND: "शहर नहीं मिला। कृपया वर्तनी जांचें या पास के किसी बड़े शहर का प्रयास करें।",
...
DATA_DELETED: "आपका सारा डेटा हटा दिया गया है। फिर से शुरू करने के लिए एक नया स्थान भेजें।",
MENU_FEEDBACK: "📝 प्रतिक्रिया",
SETTINGS_BTN_BACK: "« मुख्य मेनू पर वापस जाएं",
MAIN_MENU_PROMPT: "आप आगे क्या करना चाहेंगे?",
FEEDBACK_PROMPT: "हमें आपकी प्रतिक्रिया सुनना अच्छा लगेगा! हमारे फीडबैक बॉट के साथ चैट खोलने के लिए कृपया नीचे दिए गए बटन पर क्लिक करें।",
FEEDBACK_BTN_LABEL: "📝 प्रतिक्रिया दें"
  ...
  ru: {
    ...
    PRAYER_TIMES_FETCH_ERROR: "К сожалению, не удалось получить время намаза для этого места.",
    CITY_NOT_FOUND: "Город не найден. Пожалуйста, проверьте написание или попробуйте найти ближайший крупный город.",
    ...
    HELP_MSG: "Этот бот отправляет ежедневные уведомления о времени намаза.\n\n- Используйте /start, чтобы установить язык и местоположение.\n- Используйте меню для других опций.",
    WELCOME: "Ассаляму алейкум! Я могу предоставить время намаза для вашего местоположения.\n\nСначала, пожалуйста, выберите ваш язык:",
    CHOOSE_LANG: "Пожалуйста, выберите ваш язык:",
    LANG_UPDATED: "Язык обновлен на русский. 🇷🇺\n\nТеперь, пожалуйста, поделитесь вашим местоположением, чтобы начать.",
    SHARE_LOCATION_PROMPT: "📱 **На мобильном:** Используйте кнопку \"Поделиться местоположением\".\n💻 **На компьютере:** Просто введите название вашего города.",
    LOCATION_SAVED: "✅ Ваше местоположение сохранено! Я буду отправлять ежедневные напоминания.\n\nЧто еще вы можете сделать:",
    LOCATION_SET_TO: (city) => `✅ Местоположение установлено на "${city}". Я буду отправлять ежедневные напоминания.\n\nЧто еще вы можете сделать:`,
    PRAYER_TIMES_TODAY: "Время намаза на сегодня:",
    DONATE_MSG: "Спасибо, что решили сделать пожертвование! 🕌\n\nЭтот проект поддерживается волонтерами. Ваша поддержка помогает покрыть расходы на сервер.\n\n**Банк:** Международный Банк Кода\n**Счет:** 123-456-7890",
    ...
    DATA_DELETED: "Все ваши данные были удалены. Отправьте новое местоположение, чтобы начать снова.",
    MENU_FEEDBACK: "📝 Обратная связь",
    SETTINGS_BTN_BACK: "« Назад в главное меню",
    MAIN_MENU_PROMPT: "Что бы вы хотели сделать дальше?",
    FEEDBACK_PROMPT: "Мы будем рады услышать ваш отзыв! Пожалуйста, нажмите кнопку ниже, чтобы начать чат с нашим ботом для отзывов.",
  ...
  id: {
    ...
    LANG_UPDATED: "Bahasa diubah ke Bahasa Indonesia. 🇮🇩\n\nSekarang, silakan bagikan lokasi Anda untuk memulai.",
    SHARE_LOCATION_PROMPT: "📱 **Di Ponsel:** Gunakan tombol \"Bagikan Lokasi Saya\".\n💻 **Di Desktop:** Cukup ketik nama kota Anda.",
    LOCATION_SAVED: "✅ Lokasi Anda telah disimpan! Saya akan mengirim pengingat harian.\n\nBerikut hal lain yang bisa Anda lakukan:",
    LOCATION_SET_TO: (city) => `✅ Lokasi diatur ke "${city}". Saya akan mengirim pengingat harian.\n\nBerikut hal lain yang bisa Anda lakukan:`,
    PRAYER_TIMES_TODAY: "Waktu Sholat Hari Ini:",
    DONATE_MSG: "Terima kasih telah mempertimbangkan untuk berdonasi! 🕌\n\nProyek ini dijalankan oleh sukarelawan. Dukungan Anda membantu menutupi biaya server.\n\n**Bank:** Bank Internasional Kode\n**Rekening:** 123-456-7890",
  ...
  uz: {
    ...
    LANG_UPDATED: "Til o'zbek tiliga o'zgartirildi. 🇺🇿\n\nEndi, boshlash uchun joylashuvingizni ulashing.",
    SHARE_LOCATION_PROMPT: "📱 **Mobilda:** \"Joylashuvimni ulashish\" tugmasidan foydalaning.\n💻 **Kompyuterda:** Shahringiz nomini yozing.",
    LOCATION_SAVED: "✅ Joylashuvingiz saqlandi! Men har kuni eslatmalar yuboraman.\n\nQuyida siz qila oladigan boshqa amallar:",
    LOCATION_SET_TO: (city) => `✅ Joylashuv "${city}" ga o'rnatildi. Men har kuni eslatmalar yuboraman.\n\nQuyida siz qila oladigan boshqa amallar:`,
    PRAYER_TIMES_TODAY: "Bugungi namoz vaqtlari:",
    DONATE_MSG: "Hayriya qilishni o'ylaganingiz uchun tashakkur! 🕌\n\nBu loyiha ko'ngillilar tomonidan yuritiladi. Sizning qo'llab-quvvatlashingiz server xarajatlarini qoplashga yordam beradi.\n\n**Bank:** Xalqaro Kod Banki\n**Hisob raqam:** 123-456-7890",
  ...
  pt: {
    ...
    MENU_DONATE: "❤️ Doar",
    MENU_HELP: "❓ Ajuda",
    FETCHING_PRAYER_TIMES: "Buscando os horários de oração de hoje para você...",
    PRAYER_TIMES_FETCH_ERROR: "Desculpe, não consegui buscar os horários de oração para esse local agora.",
    CITY_NOT_FOUND: "Cidade não encontrada. Verifique a ortografia ou tente uma cidade maior próxima.",
    ...
    HELP_MSG: "Este bot envia notificações diárias dos horários de oração.\n\n- Use /start para definir seu idioma e localização.\n- Use o menu para outras opções.",
    WELCOME: "As-salamu alaikum! Eu posso fornecer os horários de oração para a sua localização.\n\nPrimeiro, por favor, escolha o seu idioma:",
    ...
    SHARE_LOCATION_PROMPT: "📱 **No Celular:** Use o botão \"Compartilhar Minha Localização\".\n💻 **No Computador:** Simplesmente digite o nome da sua cidade.",
    LOCATION_SAVED: "✅ Sua localização foi salva! Enviarei lembretes diários.\n\nVeja o que mais você pode fazer:",
    LOCATION_SET_TO: (city) => `✅ Localização definida para "${city}". Enviarei lembretes diários.\n\nVeja o que mais você pode fazer:`,
    PRAYER_TIMES_TODAY: "Horários de Oração de Hoje:",
    DONATE_MSG: "Obrigado por considerar uma doação! 🕌\n\nEste projeto é administrado por voluntários. Seu apoio ajuda a cobrir os custos do servidor.\n\n**Banco:** Banco Internacional do Código\n**Conta:** 123-456-7890",
    ...
    DATA_DELETED: "Todos os seus dados foram excluídos. Envie uma nova localização para começar de novo.",
    MENU_FEEDBACK: "📝 Feedback",
    SETTINGS_BTN_BACK: "« Voltar ao Menu Principal",
    MAIN_MENU_PROMPT: "O que você gostaria de fazer a seguir?",
    FEEDBACK_PROMPT: "Adoraríamos ouvir seu feedback! Por favor, clique no botão abaixo para abrir um chat com nosso bot de feedback.",
  ...
  fa: {
    ...
    PRAYER_TIMES_FETCH_ERROR: "متاسفانه، در حال حاضر نتوانستم اوقات شرعی آن منطقه را دریافت کنم.",
    CITY_NOT_FOUND: "شهر یافت نشد. لطفاً املا را بررسی کنید یا شهر بزرگ‌تری در نزدیکی را امتحان کنید.",
    ...
    HELP_MSG: "این ربات اعلان‌های روزانه اوقات شرعی را ارسال می‌کند.\n\n- برای تنظیم زبان و موقعیت مکانی خود از /start استفاده کنید.\n- برای گزینه‌های دیگر از منو استفاده کنید.",
    WELCOME: "السلام علیکم! من می‌توانم اوقات شرعی را برای موقعیت مکانی شما ارائه دهم.\n\nابتدا، لطفاً زبان خود را انتخاب کنید:",
    CHOOSE_LANG: "لطفاً زبان خود را انتخاب کنید:",
    LANG_UPDATED: "زبان به فارسی تغییر کرد. 🇮🇷\n\nاکنون، برای شروع لطفاً موقعیت مکانی خود را به اشتراک بگذارید.",
    SHARE_LOCATION_PROMPT: "📱 **در موبایل:** از دکمه «اشتراک‌گذاری موقعیت مکانی من» استفاده کنید.\n💻 **در دسکتاپ:** به سادگی نام شهر خود را تایپ کنید.",
    LOCATION_SAVED: "✅ موقعیت مکانی شما ذخیره شد! من یادآوری‌های روزانه ارسال خواهم کرد.\n\nکارهای دیگری که می‌توانید انجام دهید:",
    LOCATION_SET_TO: (city) => `✅ موقعیت مکانی روی «${city}» تنظیم شد. من یادآوری‌های روزانه ارسال خواهم کرد.\n\nکارهای دیگری که می‌توانید انجام دهید:`,
    PRAYER_TIMES_TODAY: "اوقات شرعی امروز:",
    DONATE_MSG: "از اینکه به حمایت مالی فکر کردید سپاسگزاریم! 🕌\n\nاین پروژه توسط داوطلبان اداره می‌شود. حمایت شما به پوشش هزینه‌های سرور کمک می‌کند.\n\n**بانک:** بانک بین‌المللی کد\n**حساب:** 123-456-7890",
    ...
    DATA_DELETED: "تمام داده‌های شما حذف شده است. برای شروع مجدد، یک موقعیت مکانی جدید ارسال کنید.",
    MENU_FEEDBACK: "📝 بازخورد",
    SETTINGS_BTN_BACK: "« بازگشت به منوی اصلی",
    MAIN_MENU_PROMPT: "در ادامه مایل به انجام چه کاری هستید؟",
    FEEDBACK_PROMPT: "خوشحال می‌شویم بازخورد شما را بشنویم! لطفاً روی دکمه زیر کلیک کنید تا یک چت با ربات بازخورد ما باز شود.",
  ...
  ms: {
    ...
    LANG_UPDATED: "Bahasa ditukar kepada Bahasa Melayu. 🇲🇾\n\nSekarang, sila kongsi lokasi anda untuk bermula.",
    SHARE_LOCATION_PROMPT: "📱 **Di Telefon Bimbit:** Guna butang \"Kongsi Lokasi Saya\".\n💻 **Di Desktop:** Hanya taip nama bandar anda.",
    LOCATION_SAVED: "✅ Lokasi anda telah disimpan! Saya akan menghantar peringatan harian.\n\nBerikut adalah perkara lain yang boleh anda lakukan:",
    LOCATION_SET_TO: (city) => `✅ Lokasi ditetapkan kepada "${city}". Saya akan menghantar peringatan harian.\n\nBerikut adalah perkara lain yang boleh anda lakukan:`,
    PRAYER_TIMES_TODAY: "Waktu Solat Hari Ini:",
    DONATE_MSG: "Terima kasih kerana mempertimbangkan untuk menderma! 🕌\n\nProjek ini dijalankan oleh sukarelawan. Sokongan anda membantu menampung kos pelayan.\n\n**Bank:** Bank Antarabangsa Kod\n**Akaun:** 123-456-7890",
  ...
  uk: {
    ...
    PRAYER_TIMES_FETCH_ERROR: "На жаль, не вдалося отримати час намазу для цього місця.",
    CITY_NOT_FOUND: "Місто не знайдено. Будь ласка, перевірте написання або спробуйте знайти найближче велике місто.",
    ...
    HELP_MSG: "Цей бот надсилає щоденні сповіщення про час намазу.\n\n- Використовуйте /start, щоб встановити мову та місцезнаходження.\n- Використовуйте меню для інших опцій.",
    WELCOME: "Ассаляму алейкум! Я можу надати час намазу для вашого місцезнаходження.\n\nСпочатку, будь ласка, оберіть вашу мову:",
    CHOOSE_LANG: "Будь ласка, оберіть вашу мову:",
    LANG_UPDATED: "Мову оновлено на українську. 🇺🇦\n\nТепер, будь ласка, поділіться вашим місцезнаходженням, щоб почати.",
    SHARE_LOCATION_PROMPT: "📱 **На мобільному:** Використовуйте кнопку \"Поділитися місцезнаходженням\".\n💻 **На комп'ютері:** Просто введіть назву вашого міста.",
    LOCATION_SAVED: "✅ Ваше місцезнаходження збережено! Я надсилатиму щоденні нагадування.\n\nЩо ще ви можете зробити:",
    LOCATION_SET_TO: (city) => `✅ Місцезнаходження встановлено на "${city}". Я надсилатиму щоденні нагадування.\n\nЩо ще ви можете зробити:`,
    PRAYER_TIMES_TODAY: "Час намазу на сьогодні:",
    DONATE_MSG: "Дякуємо, що вирішили зробити пожертву! 🕌\n\nЦей проект підтримується волонтерами. Ваша підтримка допомагає покрити витрати на сервер.\n\n**Банк:** Міжнародний Банк Коду\n**Рахунок:** 123-456-7890",
    ...
    DATA_DELETED: "Усі ваші дані було видалено. Надішліть нове місцезнаходження, щоб почати знову.",
    MENU_FEEDBACK: "📝 Зворотний зв'язок",
    SETTINGS_BTN_BACK: "« Назад до головного меню",
    MAIN_MENU_PROMPT: "Що б ви хотіли зробити далі?",
    FEEDBACK_PROMPT: "Ми будемо раді почути ваш відгук! Будь ласка, натисніть кнопку нижче, щоб розпочати чат з нашим ботом для відгуків.",
  ...
  it: {
    ...
    PRAYER_TIMES_FETCH_ERROR: "Spiacente, non sono riuscito a recuperare gli orari di preghiera per quella località.",
    CITY_NOT_FOUND: "Città non trovata. Controlla l'ortografia o prova una città più grande nelle vicinanze.",
    ...
    WELCOME: "As-salamu alaikum! Posso fornire gli orari di preghiera per la tua località.\n\nPer prima cosa, scegli la tua lingua:",
    ...
    SHARE_LOCATION_PROMPT: "📱 **Su Mobile:** Usa il pulsante \"Condividi la mia posizione\".\n💻 **Su Desktop:** Scrivi semplicemente il nome della tua città.",
    LOCATION_SAVED: "✅ La tua posizione è stata salvata! Invierò promemoria giornalieri.\n\nEcco cos'altro puoi fare:",
    LOCATION_SET_TO: (city) => `✅ Posizione impostata su "${city}". Invierò promemoria giornalieri.\n\nEcco cos'altro puoi fare:`,
    PRAYER_TIMES_TODAY: "Orari di Preghiera di Oggi:",
    DONATE_MSG: "Grazie per aver considerato una donazione! 🕌\n\nQuesto progetto è gestito da volontari. Il tuo supporto aiuta a coprire i costi del server.\n\n**Banca:** Banca Internazionale del Codice\n**Conto:** 123-456-7890",
